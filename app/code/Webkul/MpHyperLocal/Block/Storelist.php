...
class Storelist extends \Magento\Framework\View\Element\Template
{
    ...
    public function getSearchLocation($address= '')
    {
        $data = $this->getRequest()->getParams();
        $address = isset($address)?$address:10;
    ...
    public function getServiceType()
    {
        ...
        if(sizeof($savedAddress) > 0){
            ...
            if($service_type == 1){
                $service_type_text = 'Delivery';
            }else{
                $service_type_text = 'Pickup';
            }
        }
