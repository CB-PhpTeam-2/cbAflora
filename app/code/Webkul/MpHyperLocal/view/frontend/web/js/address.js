...
define([
    ...
    $.widget('mage.hyperlocaladdress', {
        ...
        saveAction : function () {
            ...
            var serviceType = $('input[name="service_type"]:checked');
            if (address.val()) {
                $.ajax({
                    ...
                    success: function (transport) {
                        ...
                        if (response.status) {
                            var redUrl = response.redirect_url;
                            var redUrlArr = redUrl.split("/cms/index/index/");
                            window.location.href = redUrlArr[0];
