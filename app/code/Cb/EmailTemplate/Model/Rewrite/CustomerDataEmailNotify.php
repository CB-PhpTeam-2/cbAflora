...
namespace Cb\EmailTemplate\Model\Rewrite;
...
class CustomerDataEmailNotify extends \Magento\Customer\Model\EmailNotification
{
    ...
    private function getFullCustomerObject($customer)
    {
        ...
        $adressData = $this->mpHypHelper->getSavedAddress();

        $adressData['lat'] = $adressData['latitude'];
        unset($adressData['latitude']);
        $adressData['lng'] = $adressData['longitude'];
        unset($adressData['latitude']);
        $adressData['country_code'] = $adressData['countryCode'];
        unset($adressData['countryCode']);
        $adressData['state_code'] = $adressData['stateCode'];
        unset($adressData['stateCode']);
        $adressData['redirect_url'] = 'cms/index/index';
        $adressData['address-id'] = 0;

        $jsonAddressData = json_encode($adressData);

        $mergedCustomerData->setCookieAddress($jsonAddressData);
